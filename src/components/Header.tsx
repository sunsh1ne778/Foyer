    ...
    <header className="bg-white text-slate-800 border-b border-slate-200 sticky top-0 z-30 select-none">
      <div className="h-14 px-4 flex items-center justify-between gap-4">
        ...
        <div className="flex-1 max-w-xl mx-auto flex items-center gap-2">
          ...
          {/* Reconcile */}
          <button
            onClick={() => triggerReconcile(currentMount)}
            title="对账此挂载 (Driver ➔ PG fs_nodes 投影索引)"
            className="p-1.5 rounded-md hover:bg-slate-100 text-slate-500 hover:text-indigo-600 transition-colors shrink-0"
          >
